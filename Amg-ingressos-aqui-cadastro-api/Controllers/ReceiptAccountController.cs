...
namespace Amg_ingressos_aqui_cadastro_api.Controllers
{
    ...
    public class ReceiptAccountController : ControllerBase
    {
        ...
        /// </summary>
        /// <param name="receiptAccountObject">Corpo conta de recebimento a ser Gravado</param>
        /// <returns>200 conta de recebimento criada</returns>
        /// <returns>500 Erro inesperado</returns>
        [HttpPost]
        [Route("createReceiptAccount")]
        ...
        /// </summary>
        /// <param name="id"> id do conta de recebimento</param>
        /// <returns>200 conta de recebimento da busca</returns>
        /// <returns>204 Nenhum conta de recebimento encontrado</returns>
        /// <returns>500 Erro inesperado</returns>
        [HttpGet]
        [Route("getReceiptAccountById")]
        [Produces("application/json")]
        public async Task<IActionResult> FindByIdReceiptAccountAsync(string id)
        {
            try
            {
        ...
        /// <returns>500 Erro inesperado</returns>
        [HttpDelete]
        public async Task<IActionResult> DeleteReceiptAccountAsync(string id)
        {
            try
            {
